...
*/
function makeSmartPerson(nameOfUser) {
  const smartPerson = {
    name: nameOfUser,
 ...
 * it will return `This is a Lincoln Navigator`.
*/
function getCarInfoById(inventory, idNumber) {
  return `This is a ${inventory[idNumber - 1].car_make} ${inventory[idNumber - 1].car_model}`;
}
